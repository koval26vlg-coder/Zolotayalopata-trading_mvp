...
$launcherFileName = "start_exact_approved_slow_liquidity_spot_v2_official_page_discovery_r3_visible.ps1"
$runtimeModule = Join-Path $repoRoot "trading_mvp\src\slow_liquidity_spot_v2_official_page_discovery_r3.py"
...
$planPath = Join-Path $repoRoot "docs\plans\slow-liquidity-spot-v2-official-page-discovery-planonly-20260815-r3.json"
...
$runId = "slow_liquidity_spot_v2_official_page_discovery_20260815_r3"
...
$expectedPlanHash = "fa527d7fcb2e01b56c1bf33f5d897e8c8ef69758b9f00963c0c1181da7658631"
$expectedPlanFileSha256 = "d14caf3556fa6707e8969263f878159a4a927e0e130577f0250bacec42b914f8"
$maxRuntimeSec = 600
...
function Assert-FrozenPlan {
    ...
    if (
        ...
        $raw -notmatch "OFFICIAL_SITEMAP_AND_VENUE_SEARCH"
    ) {
...
function New-GlobalWriterClaim {
    ...
    $raw = @(& $python $writerClaimCli `
        ...
        "--owner-kind" "slow_liquidity_spot_v2_official_page_discovery_r3" `
