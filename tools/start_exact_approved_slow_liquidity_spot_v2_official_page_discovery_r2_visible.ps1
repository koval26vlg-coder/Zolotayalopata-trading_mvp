...
$launcherFileName = "start_exact_approved_slow_liquidity_spot_v2_official_page_discovery_r2_visible.ps1"
$runtimeModule = Join-Path $repoRoot "trading_mvp\src\slow_liquidity_spot_v2_official_page_discovery_r2.py"
...
$planPath = Join-Path $repoRoot "docs\plans\slow-liquidity-spot-v2-official-page-discovery-planonly-20260815-r2.json"
...
$runId = "slow_liquidity_spot_v2_official_page_discovery_20260815_r2"
...
$expectedPlanHash = "257e2dd8590c0a6bba16b8ea0e99c3e5a40750c8cd3fa88d23acb44590112f04"
$expectedPlanFileSha256 = "e07c608c33df17d25d3a38c01f79cfe086106b5a6d04f8083157f258dad87cd6"
$maxRuntimeSec = 600
...
function Assert-FrozenPlan {
    ...
    if (
        ...
        $raw -match "https://api.mexc.com/api/v3/exchangeInfo`"" -or
        $raw -notmatch "PER_SYMBOL"
    ) {
...
function New-GlobalWriterClaim {
    ...
    $raw = @(& $python $writerClaimCli `
        ...
        "--owner-kind" "slow_liquidity_spot_v2_official_page_discovery_r2" `
