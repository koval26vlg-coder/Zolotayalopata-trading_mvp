...
$launcherFileName = "start_exact_approved_slow_liquidity_spot_v2_official_page_discovery_visible.ps1"
$runtimeModule = Join-Path $repoRoot "trading_mvp\src\slow_liquidity_spot_v2_official_page_discovery.py"
...
$planPath = Join-Path $repoRoot "docs\plans\slow-liquidity-spot-v2-official-page-discovery-planonly-20260815.json"
...
$runId = "slow_liquidity_spot_v2_official_page_discovery_20260815"
...
$expectedPlanHash = "becfd2d04871b435614f8a0785ac9e6f90c79cc3537b9868745508bc73e45d20"
$expectedPlanFileSha256 = "10d6cc6407915c49969711afc013e5865d3179b03a2166fb647c88abfd3b4360"
$maxRuntimeSec = 600
...
function New-GlobalWriterClaim {
    ...
    $raw = @(& $python $writerClaimCli `
        ...
        "--owner-kind" "slow_liquidity_spot_v2_official_page_discovery" `
...
function Assert-CompletedOutput {
    ...
    if ([bool]$manifest.v7_used -or [bool]$manifest.perp_template_used) {
        throw "Discovery output claimed v7 or perp usage."
    }
