...
SCHEMA = "trading_mvp_slow_liquidity_listing_momentum_forward_monitor_planonly_v4"
PLAN_ID = "slow_liquidity_listing_momentum_forward_monitor_20260825_v7"
AUTOMATION_ID = "zolotyaylopata-listing-momentum-forward-v2"
REPO_ROOT = Path(__file__).resolve().parents[2]
FORWARD_PLAN_PATH = (
    REPO_ROOT
    / "docs/plans"
    / "slow-liquidity-listing-momentum-forward-monitor-planonly-20260825-v7.json"
)
...
EXPECTED_IMPLEMENTATION_PATHS = {
    ...
    # decide_cadence lives here and decides this track's interval. Leaving it unbound
    # let the shared policy move to v2 without invalidating anything.
...
def rebuild_forward_state() -> dict[str, Any]:
    ...
    cadence_observation = {
        ...
        "proxy_timestamp": bool(cadence_rows),
        "source_class": "proxy" if cadence_rows else None,
    }
