...
PLAN = Path(__file__).resolve().parents[2] / "docs" / "plans" / "preipo-perpetual-event-planonly-20260824-v3.json"
...
class PreIPOPlanTests(unittest.TestCase):
    def test_immutable_plan_is_valid_and_uses_only_okx_and_gate(self) -> None:
        ...
        self.assertEqual(result["plan_id"], "preipo_perpetual_event_20260824_v3")
